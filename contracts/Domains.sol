...
// Add this anywhere in your contract body
  ...
  constructor(string memory _tld) payable ERC721("Cool Kid Name Service", "CKNS") {
    tld = _tld;
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the CoolKid name service", "image": "data:image/svg+xml;base64,',
